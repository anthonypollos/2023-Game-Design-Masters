...
namespace Highlighters_URP
{
    ...
    public class HighlightsManagerURP : ScriptableRendererFeature
    {
        ...
        private void HighlighterDataUpdate(int ID)
        {
            ...
            depthMaskPass.Dispose();
            objectsPasses[ID].Dispose();
            meshOutlinePasses[ID].Dispose();
            overlayPasses[ID].Dispose();
            perObjectBlurPasses[ID].Dispose();
        ...
        private void DisposeAllocatedMemory()
        {
