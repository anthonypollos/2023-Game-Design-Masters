Cartoon FX Remaster 3, version R 1.3
2023/11/03
...
ABOUT
-----
"Cartoon FX Remaster 3" is an update to the old "Cartoon FX Pack 3" asset.
...
"Cartoon FX Remaster 3" supports the built-in render pipeline and URP.


PREFABS
-------
Particle Systems prefabs are located in "Cartoon FX Remaster/CFXR Prefabs" folder.
All prefabs and their assets have a CFXR3_ prefix to easily recognize them.


LEGACY EFFECTS
--------------
All the old effects from "Cartoon FX Pack 3" are still available in the "Cartoon FX (legacy)" folder.


MOBILE OPTIMIZED PREFABS?
-------------------------
Unlike the Legacy effects, "Cartoon FX Remaster 3" doesn't include mobile-specific prefabs.
This is because:
- mobile devices are much more powerful compared to Cartoon FX Pack 3's initial release in 2013
...
R 1.0
- "Cartoon FX Remaster 3" first release, as a free update of "Cartoon FX Pack 3"
